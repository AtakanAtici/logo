...
@section('title', 'Düzenle-'.$order->code)
                ...
                <div class="row row-cards">
                        <div class="row">
                            <div class="col-12 col-lg-6 mt-2" >
                                <div class="form-group">
                                    ...
                                    <input type="text" id="code" name="code" class="form-control" value="{{$order->code}}" required>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6 mt-2">
                                <div class="form-group">
                                    <label for="">Tarih</label>
                                    <input type="date" id="order_date" name="order_date" class="form-control" value="{{\Carbon\Carbon::parse($order->order_date)->format('Y-m-d')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col col-lg-6">
                            ...
                            <select class="select2 form-control stock_select" id="current_id" required>
                                ...
                                <option
                                    {{$current->CODE == $order->current_id ? 'selected' : ''}}
                        ...
                        <div class="row mt-2 d-none" id="form">
                            <div class="mb-3 col col-lg-2">
                                ...
                                <select class="select2 form-control stock_select stock_id" name="stock_id[]" required>
                                    ...
                                    <option
                                        value="{{$stock->CODE}}">{{$stock->NAME}}</option>
                                @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mt-2" id="form">
                            <div class="mb-3 col col-lg-2">
                                ...
                                <select class="select2 form-control stock_select stock_id" name="stock_id[]" required>
                                    ...
                                    @foreach($stocks as $stock)
                                    <option
                                        {{$stock->CODE == $item->stock_code ? 'selected' : ''}}
                                        value="{{$stock->CODE}}">{{$stock->NAME}}</option>
                                @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3 col col-lg-1">
                                <label for="" class="form-label">Birim Fiyat</label>
                                <input type="text" class="form-control per_price money" value="{{$item->per_price}}">
                            </div>
                            <div class="mb-3 col">
                                <label for="" class="form-label text-nowrap">Vergi Oranı</label>
                                <input type="number" class="form-control tax_percent" value="{{$item->tax_percent}}">
                            </div>
                            <div class="mb-3 col">
                                <label for="" class="form-label text-nowrap">Vergi Dahil Toplam</label>
                                <input type="text" class="form-control total_price money" value="{{$item->total_price}}">
                            </div>
                            <div class="mb-3 col-1 d-flex align-items-center mt-4">
                                <button onclick="removeItem(this)" type="button" class="btn btn-sm btn-outline-danger">
                                    <i class="fa fa-trash"></i>
...
<script>
    ...
    <script src="/pages/orderUpdate.js"></script>
